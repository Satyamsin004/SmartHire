    ...
    <>
      <main className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-8 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          {/* Enhanced Interview History with Direct Report Downloads */}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800 pb-4">
                <div>
                  <h3 className="text-sm font-extrabold text-slate-900 dark:text-white uppercase tracking-wider">
                    Interview History & Download Reports
                  </h3>
                  <p className="text-[11px] text-slate-400 font-medium">Full interview scorecards, recordings, and printable PDF reports.</p>
                </div>
